...
```
{"member": "Member 1", "appliance_decisions": [{"time": "00:00-06:30", "location": "Bedroom 1", "activity": "Sleeping", "operations": [{"unique_id": "bedroom_1_fan", "action": "idle"}]}, {"time": "06:30-07:00", "location": "Bathroom", "activity": "Waking up, showering, brushing teeth and washing", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_waterheater", "action": "use"}, {"unique_id": "bathroom_dehumidifier", "action": "idle"}, {"unique_id": "bathroom_fan", "action": "idle"}]}, {"time": "07:00-07:30", "location": "Kitchen", "activity": "Boiling the kettle, making and eating a quick breakfast of toast and coffee", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_kettle", "action": "use"}, {"unique_id": "kitchen_toaster", "action": "use"}, {"unique_id": "kitchen_inductioncooker", "action": "idle"}, {"unique_id": "kitchen_rangehood", "action": "idle"}, {"unique_id": "kitchen_microwave", "action": "idle"}, {"unique_id": "kitchen_dishwasher", "action": "idle"}]}, {"time": "07:30-08:00", "location": "Bedroom 1", "activity": "Dressing for work, packing a bag and checking the phone for program updates and the blackout warning", "operations": [{"unique_id": "member_1_phone", "action": "use"}, {"unique_id": "bedroom_1_fan", "action": "idle"}]}, {"time": "08:00-09:00", "location": "Out", "activity": "Commuting to the nonprofit office in the city", "operations": [{"unique_id": "member_1_phone", "action": "idle"}, {"unique_id": "member_1_computer", "action": "idle"}]}, {"time": "09:00-12:30", "location": "Out", "activity": "Working at the office: answering emails, coordinating community programs and calling partner organisations", "operations": [{"unique_id": "member_1_computer", "action": "use"}, {"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "12:30-13:15", "location": "Out", "activity": "Taking a lunch break and eating lunch near the office", "operations": [{"unique_id": "member_1_computer", "action": "idle"}, {"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "13:15-17:00", "location": "Out", "activity": "Working at the office: planning upcoming community events, scheduling volunteers and preparing materials", "operations": [{"unique_id": "member_1_computer", "action": "use"}, {"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "17:00-18:00", "location": "Out", "activity": "Commuting home from the office", "operations": [{"unique_id": "member_1_computer", "action": "idle"}, {"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "18:00-19:00", "location": "Kitchen", "activity": "Cooking a simple dinner on the induction cooker and eating it before the evening peak", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_inductioncooker", "action": "use"}, {"unique_id": "kitchen_rangehood", "action": "use"}, {"unique_id": "kitchen_microwave", "action": "idle"}, {"unique_id": "kitchen_dishwasher", "action": "idle"}, {"unique_id": "kitchen_kettle", "action": "idle"}, {"unique_id": "kitchen_toaster", "action": "idle"}]}, {"time": "19:00-19:30", "location": "Kitchen", "activity": "Washing dishes by hand and tidying the kitchen", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_dishwasher", "action": "idle"}, {"unique_id": "kitchen_inductioncooker", "action": "idle"}, {"unique_id": "kitchen_rangehood", "action": "idle"}]}, {"time": "19:30-21:00", "location": "Living Room", "activity": "Relaxing on the sofa, reading and keeping non-essential appliances switched off during the rolling blackout warning window", "operations": [{"unique_id": "living_room_light", "action": "use"}, {"unique_id": "living_room_tv", "action": "idle"}, {"unique_id": "living_room_airconditioner", "action": "idle"}, {"unique_id": "living_room_gameconsole", "action": "idle"}, {"unique_id": "living_room_vacuumcleaner", "action": "idle"}]}, {"time": "21:00-21:30", "location": "Bathroom", "activity": "Taking an evening shower and completing night-time hygiene routine", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_waterheater", "action": "use"}, {"unique_id": "bathroom_dehumidifier", "action": "idle"}, {"unique_id": "bathroom_fan", "action": "idle"}]}, {"time": "21:30-22:30", "location": "Bedroom 1", "activity": "Using the computer and phone for personal admin, reviewing tomorrow's program schedule and charging devices while the fan runs", "operations": [{"unique_id": "member_1_computer", "action": "use"}, {"unique_id": "member_1_desklamp", "action": "use"}, {"unique_id": "member_1_phone", "action": "charge_home"}, {"unique_id": "bedroom_1_fan", "action": "use"}]}, {"time": "22:30-23:00", "location": "Bedroom 1", "activity": "Winding down, reading and turning off the phone", "operations": [{"unique_id": "member_1_computer", "action": "idle"}, {"unique_id": "member_1_desklamp", "action": "idle"}, {"unique_id": "member_1_phone", "action": "idle"}, {"unique_id": "bedroom_1_fan", "action": "idle"}]}, {"time": "23:00-24:00", "location": "Bedroom 1", "activity": "Sleeping", "operations": [{"unique_id": "bedroom_1_fan", "action": "idle"}]}]}
```
