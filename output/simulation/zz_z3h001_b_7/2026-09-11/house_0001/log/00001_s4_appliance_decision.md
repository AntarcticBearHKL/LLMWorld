...
- member_2_electricvehicle: 6.30 AUD now (peak) vs 1.26 AUD off-peak — save 5.04 per hour
- member_3_phone: 0.02 AUD now (peak) vs 0.00 AUD off-peak — save 0.01 per hour
- member_4_phone: 0.02 AUD now (peak) vs 0.00 AUD off-peak — save 0.01 per hour
- member_5_phone: 0.02 AUD now (peak) vs 0.00 AUD off-peak — save 0.01 per hour
- member_6_phone: 0.02 AUD now (peak) vs 0.00 AUD off-peak — save 0.01 per hour
...
```
{"member": "Member 1", "appliance_decisions": [{"time": "00:00-07:00", "location": "Bedroom 1", "activity": "Sleeping", "operations": [{"unique_id": "bedroom_1_light", "action": "idle"}, {"unique_id": "bedroom_1_fan", "action": "idle"}, {"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "07:00-07:30", "location": "Bathroom", "activity": "Waking up, showering and washing", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_waterheater", "action": "use"}]}, {"time": "07:30-08:00", "location": "Kitchen", "activity": "Making and eating a simple flexitarian breakfast of toast and fruit with a cup of tea", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_toaster", "action": "use"}, {"unique_id": "kitchen_kettle", "action": "use"}]}, {"time": "08:00-08:25", "location": "Bedroom 1", "activity": "Packing study bag, checking written reminders and the day's to-do list, and confirming the class timetable", "operations": [{"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "bedroom_1_fan", "action": "idle"}]}, {"time": "08:25-09:15", "location": "Out", "activity": "Commuting by train and bus from home to the Monash University Clayton campus", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "09:15-12:00", "location": "Out", "activity": "Attending Master of Social Work coursework lectures and tutorials", "operations": [{"unique_id": "member_1_phone", "action": "idle"}, {"unique_id": "member_1_computer", "action": "idle"}]}, {"time": "12:00-12:40", "location": "Out", "activity": "Eating a packed flexitarian lunch on campus and resting quietly", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "12:40-16:30", "location": "Out", "activity": "Attending afternoon social work seminars and studying in the campus library", "operations": [{"unique_id": "member_1_computer", "action": "use"}, {"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "16:30-17:30", "location": "Out", "activity": "Commuting home by bus and train", "operations": [{"unique_id": "member_1_phone", "action": "use"}, {"unique_id": "member_1_computer", "action": "idle"}]}, {"time": "17:30-18:15", "location": "Kitchen", "activity": "Cooking a batch of vegetarian curry and rice while keeping the shared bench tidy", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_inductioncooker", "action": "use"}, {"unique_id": "kitchen_rangehood", "action": "use"}, {"unique_id": "kitchen_ricecooker", "action": "run"}]}, {"time": "18:15-18:50", "location": "Kitchen", "activity": "Eating dinner at the kitchen table with a cup of tea", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_kettle", "action": "use"}, {"unique_id": "kitchen_inductioncooker", "action": "idle"}, {"unique_id": "kitchen_rangehood", "action": "idle"}]}, {"time": "18:50-19:20", "location": "Kitchen", "activity": "Washing up dishes, wiping the bench and putting away the leftover food", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_dishwasher", "action": "idle"}, {"unique_id": "kitchen_ricecooker", "action": "idle"}]}, {"time": "19:20-20:30", "location": "Bedroom 1", "activity": "Writing assignment notes on the computer and reviewing placement paperwork and reminders", "operations": [{"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "member_1_desklamp", "action": "use"}, {"unique_id": "member_1_computer", "action": "use"}, {"unique_id": "member_1_monitor", "action": "use"}]}, {"time": "20:30-20:50", "location": "Kitchen", "activity": "Making a cup of tea and having a light snack", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_kettle", "action": "use"}, {"unique_id": "member_1_desklamp", "action": "idle"}, {"unique_id": "member_1_computer", "action": "idle"}, {"unique_id": "member_1_monitor", "action": "idle"}]}, {"time": "20:50-22:00", "location": "Bedroom 1", "activity": "Continuing written study tasks and updating the weekly budget notes in cash-spending records", "operations": [{"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "member_1_desklamp", "action": "use"}, {"unique_id": "member_1_computer", "action": "use"}, {"unique_id": "member_1_monitor", "action": "use"}]}, {"time": "22:00-22:30", "location": "Bathroom", "activity": "Evening routine of brushing teeth and washing up before bed", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_waterheater", "action": "idle"}, {"unique_id": "member_1_desklamp", "action": "idle"}, {"unique_id": "member_1_computer", "action": "idle"}, {"unique_id": "member_1_monitor", "action": "idle"}]}, {"time": "22:30-24:00", "location": "Bedroom 1", "activity": "Winding down with a photo of the family dog, setting alarms and reminders, then sleeping", "operations": [{"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "bedroom_1_fan", "action": "idle"}, {"unique_id": "member_1_phone", "action": "charge_home"}]}]}
```
