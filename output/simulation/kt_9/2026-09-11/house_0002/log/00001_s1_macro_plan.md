...
```
{
  ...
  "activities": [
    ...
    {"time": "19:00-22:30", "location": "Living Room", "activity": "Relaxing, watching TV and using computer; using fan instead of air conditioner to save energy during peak hours"},
