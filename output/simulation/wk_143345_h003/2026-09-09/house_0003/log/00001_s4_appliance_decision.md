...
```
{"member": "Member 1", "appliance_decisions": [{"time": "00:00-06:30", "location": "Bedroom 1", "activity": "Sleeping", "operations": [{"unique_id": "bedroom_1_light", "action": "idle"}, {"unique_id": "bedroom_1_tv", "action": "idle"}, {"unique_id": "bedroom_1_airconditioner", "action": "idle"}, {"unique_id": "bedroom_1_desklamp", "action": "idle"}]}, {"time": "06:30-07:00", "location": "Bathroom", "activity": "Wake up, wash, and take morning medication", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_fan", "action": "idle"}, {"unique_id": "bathroom_waterheater", "action": "idle"}, {"unique_id": "bathroom_dehumidifier", "action": "idle"}]}, {"time": "07:00-07:30", "location": "Kitchen", "activity": "Prepare and eat breakfast, feed dog", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_inductioncooker", "action": "use"}, {"unique_id": "kitchen_rangehood", "action": "use"}, {"unique_id": "kitchen_toaster", "action": "use"}, {"unique_id": "kitchen_microwave", "action": "idle"}, {"unique_id": "kitchen_kettle", "action": "idle"}, {"unique_id": "kitchen_ricecooker", "action": "idle"}, {"unique_id": "kitchen_oven", "action": "idle"}, {"unique_id": "kitchen_dishwasher", "action": "idle"}]}, {"time": "07:30-08:00", "location": "Out", "activity": "Morning school run and drop-off via public transit", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "08:00-09:00", "location": "Out", "activity": "Commute to clinic via public transit", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "09:00-12:30", "location": "Out", "activity": "On-site work at clinic: patient appointments and health checks", "operations": [{"unique_id": "member_1_phone", "action": "idle"}, {"unique_id": "member_1_computer", "action": "idle"}]}, {"time": "12:30-13:00", "location": "Out", "activity": "Lunch break at clinic", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "13:00-15:00", "location": "Out", "activity": "Community visits and home appointments", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "15:00-16:00", "location": "Out", "activity": "Run errands: pick up supplies and medications", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "16:00-17:00", "location": "Out", "activity": "Return to clinic, complete paperwork", "operations": [{"unique_id": "member_1_computer", "action": "use"}, {"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "17:00-17:45", "location": "Out", "activity": "Commute home via public transit", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "17:45-18:15", "location": "Out", "activity": "Walk dog around neighborhood", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "18:15-18:45", "location": "Kitchen", "activity": "Prepare dinner", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_inductioncooker", "action": "use"}, {"unique_id": "kitchen_rangehood", "action": "use"}, {"unique_id": "kitchen_microwave", "action": "idle"}, {"unique_id": "kitchen_kettle", "action": "idle"}, {"unique_id": "kitchen_toaster", "action": "idle"}, {"unique_id": "kitchen_ricecooker", "action": "idle"}, {"unique_id": "kitchen_oven", "action": "idle"}, {"unique_id": "kitchen_dishwasher", "action": "idle"}]}, {"time": "18:45-19:00", "location": "Dining Room", "activity": "Eat dinner", "operations": [{"unique_id": "dining_room_light", "action": "use"}, {"unique_id": "dining_room_airconditioner", "action": "idle"}]}, {"time": "19:00-20:00", "location": "Study", "activity": "Personal study and reading", "operations": [{"unique_id": "study_light", "action": "use"}, {"unique_id": "study_desklamp", "action": "use"}, {"unique_id": "study_computer", "action": "idle"}, {"unique_id": "study_monitor", "action": "idle"}]}, {"time": "20:00-20:30", "location": "Bedroom 1", "activity": "Text check-ins with relatives and neighbors", "operations": [{"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "member_1_phone", "action": "use"}, {"unique_id": "bedroom_1_tv", "action": "idle"}, {"unique_id": "bedroom_1_airconditioner", "action": "idle"}]}, {"time": "20:30-21:30", "location": "Bedroom 1", "activity": "Relax and watch TV", "operations": [{"unique_id": "bedroom_1_tv", "action": "use"}, {"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "bedroom_1_airconditioner", "action": "idle"}, {"unique_id": "bedroom_1_desklamp", "action": "idle"}]}, {"time": "21:30-22:00", "location": "Bathroom", "activity": "Evening hygiene and take evening medication", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_waterheater", "action": "use"}, {"unique_id": "bathroom_fan", "action": "use"}, {"unique_id": "bathroom_dehumidifier", "action": "idle"}]}, {"time": "22:00-22:30", "location": "Bedroom 1", "activity": "Quiet reading or devotional time", "operations": [{"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "bedroom_1_desklamp", "action": "use"}, {"unique_id": "bedroom_1_tv", "action": "idle"}, {"unique_id": "bedroom_1_airconditioner", "action": "idle"}]}, {"time": "22:30-24:00", "location": "Bedroom 1", "activity": "Sleeping", "operations": [{"unique_id": "bedroom_1_light", "action": "idle"}, {"unique_id": "bedroom_1_tv", "action": "idle"}, {"unique_id": "bedroom_1_airconditioner", "action": "idle"}, {"unique_id": "bedroom_1_desklamp", "action": "idle"}, {"unique_id": "member_1_phone", "action": "charge_home"}]}]}
```
