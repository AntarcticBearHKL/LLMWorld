...
```
{
  "member": "Member 1",
  "activities": [
    {"time": "00:00-06:20", "location": "Bedroom 1", "activity": "Sleeping; phone on silent on the nightstand"},
    {"time": "06:20-06:35", "location": "Bathroom", "activity": "Waking up, washing face, brushing teeth, taking morning chronic-condition medication"},
    {"time": "06:35-06:55", "location": "Out", "activity": "Walking the dog around the block on the usual short loop"},
    {"time": "06:55-07:10", "location": "Kitchen", "activity": "Making and eating a quick breakfast, packing a packed lunch and refilling a water bottle"},
    {"time": "07:10-07:30", "location": "Bedroom 1", "activity": "Dressing for the clinic and school day, checking phone messages and confirming the day's appointment list"},
    {"time": "07:30-08:00", "location": "Out", "activity": "School run and drop-off before the shift begins"},
    {"time": "08:00-08:35", "location": "Out", "activity": "Public transit commute toward the school and clinic district"},
    {"time": "08:35-09:00", "location": "Out", "activity": "Arriving on site, signing in and setting up materials for the morning education aide block"},
    {"time": "09:00-11:30", "location": "Out", "activity": "Primary education aide duties: supporting classroom routines and one-on-one reading help"},
    {"time": "11:30-12:00", "location": "Out", "activity": "Transit between the school and the community clinic"},
    {"time": "12:00-12:30", "location": "Out", "activity": "Short lunch break while reviewing the afternoon appointment notes on the phone"},
    {"time": "12:30-16:30", "location": "Out", "activity": "Community healthcare shift at the clinic: scheduled client appointments, health checks and care-plan paperwork"},
    {"time": "16:30-17:00", "location": "Out", "activity": "Community visit and a quick errand on the way back toward the transit stop"},
    {"time": "17:00-17:45", "location": "Out", "activity": "Public transit commute home"},
    {"time": "17:45-18:00", "location": "Bedroom 1", "activity": "Changing out of work clothes, washing hands and putting the work bag and keys away"},
    {"time": "18:00-18:45", "location": "Dining Room", "activity": "Eating a home-cooked dinner and talking through the day"},
    {"time": "18:45-19:20", "location": "Kitchen", "activity": "Washing dishes, wiping benches and prepping tomorrow's lunch containers"},
    {"time": "19:20-19:50", "location": "Out", "activity": "Evening dog walk along the quiet neighbourhood streets"},
    {"time": "19:50-20:40", "location": "Living Room", "activity": "One-on-one text check-ins with relatives and neighbours, catching up on every detail"},
    {"time": "20:40-21:30", "location": "Study", "activity": "Logging clinic notes and replying to community outreach messages on the computer"},
    {"time": "21:30-21:55", "location": "Bathroom", "activity": "Showering, laying out tomorrow's clothes and taking evening medication"},
    {"time": "21:55-22:20", "location": "Bedroom 1", "activity": "Low-volume TV wind-down under the desk lamp while the phone charges"},
    {"time": "22:20-24:00", "location": "Bedroom 1", "activity": "Lights out and sleeping"}
  ]
}
```
