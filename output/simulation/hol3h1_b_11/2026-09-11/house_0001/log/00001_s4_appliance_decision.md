...
```
{"member": "Member 1", "appliance_decisions": [{"time": "00:00-06:30", "location": "Bedroom 1", "activity": "Sleeping", "operations": [{"unique_id": "bedroom_1_light", "action": "idle"}, {"unique_id": "bedroom_1_fan", "action": "idle"}]}, {"time": "06:30-07:00", "location": "Bathroom", "activity": "Washing and getting dressed", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_waterheater", "action": "idle"}]}, {"time": "07:00-07:30", "location": "Kitchen", "activity": "Preparing and eating breakfast (flexitarian, tea)", "operations": [{"unique_id": "kitchen_light", "action": "use"}, {"unique_id": "kitchen_kettle", "action": "use"}, {"unique_id": "kitchen_microwave", "action": "idle"}, {"unique_id": "kitchen_inductioncooker", "action": "idle"}, {"unique_id": "kitchen_rangehood", "action": "idle"}]}, {"time": "07:30-08:30", "location": "Out", "activity": "Commuting to Monash University via train and bus", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "08:30-09:00", "location": "Out", "activity": "Arriving at campus and preparing for classes", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "09:00-13:00", "location": "Out", "activity": "Attending social work classes and seminars", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "13:00-14:00", "location": "Out", "activity": "Eating packed lunch and reviewing notes", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "14:00-17:00", "location": "Out", "activity": "Attending more classes and group study", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "17:00-18:00", "location": "Out", "activity": "Commuting to aged-care facility for evening shift", "operations": [{"unique_id": "member_1_phone", "action": "use"}]}, {"time": "18:00-22:00", "location": "Out", "activity": "Working as aged-care support worker (evening shift), including a break to eat a packed flexitarian dinner", "operations": [{"unique_id": "member_1_phone", "action": "idle"}]}, {"time": "22:00-23:00", "location": "Out", "activity": "Commuting home via public transport", "operations": [{"unique_id": "member_1_phone", "action": "charge_external"}]}, {"time": "23:00-23:30", "location": "Bathroom", "activity": "Showering and getting ready for bed", "operations": [{"unique_id": "bathroom_light", "action": "use"}, {"unique_id": "bathroom_waterheater", "action": "use"}]}, {"time": "23:30-24:00", "location": "Bedroom 1", "activity": "Setting reminders and going to sleep", "operations": [{"unique_id": "bedroom_1_light", "action": "use"}, {"unique_id": "member_1_phone", "action": "charge_home"}, {"unique_id": "bedroom_1_fan", "action": "idle"}]}]}
```
