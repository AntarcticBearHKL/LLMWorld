...
```
{
  ...
  "activities": [
    ...
    {"time": "18:00-19:00", "location": "Kitchen", "activity": "Eating dinner (using fan instead of AC due to peak request)"},
    {"time": "19:00-22:30", "location": "Living Room", "activity": "Relaxing, watching TV and using computer (using fan until 20:00, then AC)"},
