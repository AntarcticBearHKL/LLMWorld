...
- living_room_phone: 0.02 AUD now (peak) vs 0.00 AUD off-peak — save 0.01 per hour
- dining_room_airconditioner: 1.80 AUD now (peak) vs 0.36 AUD off-peak — save 1.44 per hour
- laundry_washingmachine: 0.54 AUD now (peak) vs 0.11 AUD off-peak — save 0.43 per cycle
- laundry_clothesdryer: 2.25 AUD now (peak) vs 0.45 AUD off-peak — save 1.80 per cycle
