...
| **停电预警 → 峰段削减** | N=3：4.686→3.203 kWh | **−31.7%**（z≈−9.6；跨3世界方向复现 −7.3%~−31.7%） |
...
| 停电预警 blackout_risk | RQ2 | Xia et al. 2026 | 避开晚峰 | 有效果(方向跨3世界:峰段 −7.3%~−31.7%) | `experiments/event_blackout_risk.md` |
