...
3. Alignment experiments against empirical benchmarks (Faruqui & Sergici 2010; Allcott 2011;
   Costa & Kahn 2010; Xia et al. 2026; …), yielding **seven statistically significant natural-language
   ...
   → AC-off/peak-shaving** (AC-on 15/15→7/15, p≈0.0022; peak −22.5%/−24.6%/−20.6%), and a **stay-home
   family** raising total energy — **holiday** (+19%…+65%, p≤0.019), **work-from-home**
   (+28.7%/+30.6%/+30.6%, p≤0.014) and **transport strike** (+22.2%/+29.3%/+33.9%, p≤0.039).
