...
**Cross-household replicate — house_0001 Member 1 (R043)**：baseline 10.081 kWh → nudge 8.409 kWh
（**−16.59%**）。跨两住户的 nudge 总量变化：house_0002 −10.29% / −5.76%，house_0001 −16.59% —— **方向一致，幅度均超 −1~3% 基准**。
...
- **初步**：固定社会规范 nudge（含规范性措辞）在**两个住户**上一致降低总用电
  （house_0002 −6~−10%、house_0001 −16.6%），方向正确但幅度均超基准；
