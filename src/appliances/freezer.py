...
class Freezer(AlwaysOnAppliance):
    def __init__(self, brand=None, power=None, daily_energy_kwh=None, age=0, location=None, owner=None, location_id=None, owner_id=None, **meta):
        ...
        daily_kwh = daily_energy_kwh if daily_energy_kwh is not None else 1.0
        super().__init__("Freezer", power_watts=power_watts, daily_energy_kwh=daily_kwh,
    ...
    def get_config_schema(cls):
        return {
            "type": "Freezer",
            "description": "Chest or upright freezer (always running)",
            "config_fields": {
                "brand": {
                    "type": "string",
