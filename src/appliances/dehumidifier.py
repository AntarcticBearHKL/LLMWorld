...
class Dehumidifier(OnDemandAppliance):
    def __init__(self, brand=None, power=None, age=0, location=None, owner=None, location_id=None, owner_id=None, **meta):
        ...
        super().__init__("Dehumidifier", power_watts=power_watts, brand=brand, age=age,
    ...
    def get_config_schema(cls):
        return {
            "type": "Dehumidifier",
            "description": "Dehumidifier (removes moisture from the air)",
            "config_fields": {
                "brand": {
                    "type": "string",
