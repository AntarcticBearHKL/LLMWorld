        ...
        return (
          <li key={room.room} className="border-b border-border last:border-b-0">
            <div className="flex items-baseline gap-2 px-3 py-1.5">
              <span className="min-w-0 flex-1 truncate t-caption text-fg">
                {room.room}
              </span>
              <span className="shrink-0 t-micro">
                  ...
                  return (
                    <li key={pose.uniqueId}>
                      ...
                      >
                        <span
                          className={cn(
                            "min-w-0 flex-1 truncate t-caption",
                            live ? "text-fg" : "text-fg-subtle",
                          )}
                        >
                          {pose.label}
                        </span>
                        <span className="num shrink-0 t-caption text-fg-subtle">
